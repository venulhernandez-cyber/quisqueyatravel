// ── Hoteles base — links de afiliado Stay22 (quisqueyatravel) — v6 ──────────
...
var HOTELES_BASE = {
  'punta-cana': {
    destino: 'Punta Cana',
    hoteles: [
      { nombre: 'Barcelo Bavaro Palace', precio: 'Desde $120/noche', puntuacion: '8.6 Excelente', imagen: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=500&q=80', emoji: '🌴', link: addr('Punta Cana', 'punta_cana') },
      { nombre: 'Hard Rock Hotel & Casino Punta Cana', precio: 'Desde $145/noche', puntuacion: '8.4 Muy bueno', imagen: 'https://images.unsplash.com/photo-1445019980597-93fa8acb246c?w=500&q=80', emoji: '🎸', link: addr('Punta Cana', 'punta_cana') },
      { nombre: 'Riu Palace Macao', precio: 'Desde $95/noche', puntuacion: '8.8 Excelente', imagen: 'https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=500&q=80', emoji: '🏖️', link: addr('Punta Cana', 'punta_cana') },
      { nombre: 'Majestic Elegance Punta Cana', precio: 'Desde $110/noche', puntuacion: '8.7 Excelente', imagen: 'https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=500&q=80', emoji: '🌺', link: addr('Punta Cana', 'punta_cana') }
    ]
  },
  'santo-domingo': {
    destino: 'Santo Domingo',
    hoteles: [
      { nombre: 'Hotel Hodelpa Caribe Colonial', precio: 'Desde $55/noche', puntuacion: '8.2 Muy bueno', imagen: 'https://images.unsplash.com/photo-1568084680786-a84f91d1153c?w=500&q=80', emoji: '🏛️', link: addr('Santo Domingo', 'santo_domingo') },
      ...
      { nombre: 'InterContinental Real Santo Domingo', precio: 'Desde $95/noche', puntuacion: '8.7 Excelente', imagen: 'https://images.unsplash.com/photo-1568084680786-a84f91d1153c?w=500&q=80', emoji: '🏙️', link: addr('Santo Domingo', 'santo_domingo') },
      { nombre: 'Hotel El Embajador, Autograph Collection', precio: 'Desde $88/noche', puntuacion: '8.4 Muy bueno', imagen: 'https://images.unsplash.com/photo-1551882547-ff40c4c79d4d?w=500&q=80', emoji: '🌆', link: addr('Santo Domingo', 'santo_domingo') }
    ]
  },
  'puerto-plata': {
    destino: 'Puerto Plata',
    hoteles: [
      { nombre: 'Cofresi Palm Beach & Spa Resort', precio: 'Desde $65/noche', puntuacion: '7.9 Bueno', imagen: 'https://images.unsplash.com/photo-1584132967334-10e028bd69f7?w=500&q=80', emoji: '⛰️', link: addr('Puerto Plata', 'puerto_plata') },
      { nombre: 'Viva Wyndham V Heavens', precio: 'Desde $70/noche', puntuacion: '7.6 Bueno', imagen: 'https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=500&q=80', emoji: '🌊', link: addr('Puerto Plata', 'puerto_plata') },
      { nombre: 'Lifestyle Tropical Beach Resort & Spa', precio: 'Desde $72/noche', puntuacion: '7.8 Bueno', imagen: 'https://images.unsplash.com/photo-1584132967334-10e028bd69f7?w=500&q=80', emoji: '🏝️', link: addr('Puerto Plata', 'puerto_plata') },
  ...
  'la-romana': {
    destino: 'La Romana',
    hoteles: [
      { nombre: 'Casa de Campo Resort & Villas', precio: 'Desde $130/noche', puntuacion: '9.1 Excepcional', imagen: 'https://images.unsplash.com/photo-1571003123894-1f0594d2b5d9?w=500&q=80', emoji: '🎨', link: addr('La Romana', 'la_romana') },
  ...
  'santiago': {
    ...
    hoteles: [
      ...
      { nombre: 'Hodelpa Centro Plaza', precio: 'Desde $45/noche', puntuacion: '7.8 Bueno', imagen: 'https://images.unsplash.com/photo-1551882547-ff40c4c79d4d?w=500&q=80', emoji: '🏙️', link: addr('Santiago de los Caballeros', 'santiago') },
